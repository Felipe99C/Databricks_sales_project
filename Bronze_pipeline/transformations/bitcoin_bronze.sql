create or refresh streaming live table lakehouse.bronze.bitcoin
tblproperties("quality"="bronze")

--informa o caminho do arquivo
select * from cloud_files('/Volumes/lakehouse/raw_public/coinbase/coinbase/bitcoin_spot/', 'json',
map(
